...
<html>
    <head>
        ...
        <title>Catégorie fromage - TOUT EN FROMAGE, vente de fromage et plateaux de fromage à Saint-Étienne</title>
        <meta name="description" content="Ventes de fromages en ligne ou en boutique, livraison rapide et sécurisé, fromages de vache, fromages de chèvres, fondues, fromages à la maturité de votre choix, fromages aux normes environnementales certifié."/>
    </head>

    <body onscroll="backToTop(), changeHeader();">
        <?php include("parties/header.php"); ?>
        <div class="slider small-none">
            <img src="img/slider_fromage.jpg" alt="lot de fromages sur une table"/>
            <p class="slogan-page">Tout les fromages</p>
        </div>
        ...
        <main>
            ...
            <div class="container">
                ...
                <div class="menu-small large-none medium-flex small-flex justify-center align-center" onclick="afficheCategorie();"><?php include("img/fleche-droite.svg") ?></div>
            <div class="menu-categorie small-none medium-none ">
